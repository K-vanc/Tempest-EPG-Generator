...
return array (
  ...
  'max_day' => '15',
  'episodeOption' => '1',
  'url1' => 'https://m-net.dstv.com/tv-guide-day.json?date=##urldate1##&channels=##channel##',
  'requestOption1' => '1',
  ...
  'stop_format' => 'H#i',
  'title' => '"title":"(.*?)","',
  'subtitle' => '"blurb":"\'(.*?)\'||#replace#(S\\d+(?:\\/E\\d+(?:\\sof\\s\\d+)?)?)##(E\\d+(?:\\sof\\s\\d+)?)||##',
  'desc' => '"blurb":"(.*?)","||#replace#^(\'.*?\'\\.\\s)||',
  'season' => '"season":"(\\d+)|>|"sub_title":"Season (\\d+)|>|"blurb":"\'S(\\d+)',
  'episode' => '"sub_title":".*?Episode (\\d+)"|>|"blurb":".*?E(\\d+)',
  'episode_total' => '"blurb":".*?E\\d+ of (\\d+)\'',
  'channel_logo' => '"image":{"normal":"(.*?)"',
  'new' => '"is_(new)":true,',
  'ccurl1' => 'https://m-net.dstv.com/south/home',
  'ccrequestOption1' => '1',
