...
return array (
  ...
  'culture' => 'en',
  'max_day' => '6.1',
  'url1' => 'https://www.alsharqiya.com/en/tv-schedule',
  'requestOption1' => '1',
  ...
  'show' => 'id="solid-justified-tab[##urldate1##-##stopdate1##]">.*?(?:<div class="col-xs-)(.*?)(?:<\\/div>\\s*<\\/div>).*?<\\/div>\\s*<\\/div>\\s*(?:<div class="col-md-4">|<div class="tab-pane)||#include#>##channel## Programs<',
  'start' => '"schedule-hour">(.*?)<\\/',
  'start_format' => 'H#i',
  ...
  'ccrequestOption1' => '1',
  'ccchannel_id' => '||#set#AlSharqiya|AlSharqiya News',
